...
namespace LabsTogether2.src.other
{
    ...
    public static class RightTriangleExtension
    {
        ...
        public static double RightTriangleСalculateS(this Triangle triangle, double k1, double k2)
        {
        ...
        public static double RightTriangleСalculateS(this Triangle triangle, double k, double angle, bool angleIsRad)
        {
        ...
        /// <param name="angle">Острый угол.</param>
        public static double RightTriangleСalculateS1(this Triangle triangle, double g, double angle, bool angleIsRad)
        {
